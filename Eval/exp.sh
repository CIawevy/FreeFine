...
#python data_gen_utils/our_model_infer_edit.py  --base_dir "$BASE_DIR" --method_name 'mtsa' --data_id "$DATA_ID"
...
#python data_gen_utils/our_model_infer_edit_merge.py  --base_dir "$BASE_DIR" --method_name 'mtsa'
#conda deactivate
