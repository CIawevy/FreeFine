...
if __name__ == '__main__':
    ...
    image_path ="/data/Hszhu/dataset/partial-editing/imgs/crocodile.jpg"
    mask_path = "/data/Hszhu/dataset/partial-editing/masks/level1/crocodile/mask_1.png"
    inp_path  = None
    ...
    #resize img
    #rm bg
    # constrain_areas = get_constrain_areas([ori_mask_path])
    ...
    angle_list_3d = [-5,-10,-20,20,10,5-15,15]  # for easier fetch
    ...
    if len(angle_list_3d) > 0:
        ...
        for edit_index, angle_select in enumerate(angle_list_3d):
            ...
            coarse = Image.fromarray(coarse_edit_res).save(f"/data/Hszhu/dataset/temp/coarse_3d_{edit_index}.png")
            target_mask = Image.fromarray(transfered_mask).save(f"/data/Hszhu/dataset/temp/target_mask_3d_{edit_index}.png")
