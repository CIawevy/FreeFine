...
def main():
    ...
    dst_dir_path_gen = osp.join(base_dir,"Gen_results_DesignEdit_bg/")
    ...
    for da_n, da in tqdm(data.items(), desc=f'Proceeding editing'):
        ...
        for ins_id,current_ins in instances.items():
            ...
            for edit_ins,coarse_input_pack in current_ins.items():
                ...
                # ori_img_path = "/data/Hszhu/FreeFine/Examples/Removal/lamp/source.png"
                ori_img = read_and_resize_img(ori_img_path)

                ori_mask_path = coarse_input_pack['ori_mask_path']
                # ori_mask_path = "/data/Hszhu/FreeFine/Examples/Removal/lamp/mask.png"
                ...
                # rz = -rz
                with torch.no_grad():
                    generated_results = model.run_remove(
                        ori_img, ori_mask
                    )
    ...
    save_json(new_data,osp.join(base_dir,f"generated_results_DesignEdit_bg.json"))
    # remove temp file
