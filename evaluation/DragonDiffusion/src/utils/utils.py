...
def process_move(path_mask, h, w, dx, dy, rz, center, scale, input_scale, resize_scale, up_scale, up_ft_index, w_edit, w_content, w_contrast, w_inpaint,  precision, path_mask_ref=None):
    ...
    mask_tar = rotate(mask_tar, -rz, center=center, fill=[0.0])
