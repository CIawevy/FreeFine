...
def main():
    ...
    # Generation args
    parser.add_argument("--save_dir", default="results/teapot.down150", help='Path to save results')
    parser.add_argument("--num_samples", default=1, type=int, help='Number of samples to generate')
    parser.add_argument("--input_dir", type=str, default="./data/teapot", help='location of src img, flows, etc.')
    ...
    # Guidance args
    parser.add_argument("--target_flow_name", type=str, default="down150.pth", help='Path to target image. If no path, then default to constant flow')
    parser.add_argument("--edit_mask_path", type=str, default='down150.mask.pth', help='path to edit mask')
