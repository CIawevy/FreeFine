...
choice_dict = {
    ...
    '2':['Examples/Removal/lamp/source.png','Examples/Removal/lamp/mask.png','empty grass scene'],
    ...
    '5':['Examples/Removal/rose/source.png','Examples/Removal/rose/mask.png','empty scene'],
}
sample_id = '2'
...
generated_results = model.FreeFine_background_generation(ori_img, dil_ori_mask, prompt,
                                                         ...
                                                         seed=seed_r,
                                                         return_intermediates=False,latent_blended=True,blend_range=(0,40),
                                                         )
