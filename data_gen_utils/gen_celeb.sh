...
#cd /data/Hszhu/ShareGPT4V/
#bash scripts/run_captioning_sa1b.sh
#conda deactivate
...
#python infer_fooocus_mat_celeb.py --data_id "$DATA_ID" --base_dir "$BASE_DIR"
#conda deactivate
...
##pt2 coarse edit
#python scripts/sampling/coarse_editing_2d_3d_parser_celeb.py --data_id "$DATA_ID" --base_dir "$BASE_DIR"
#conda deactivate
