...
def main(dst_base,gen_dir):
    if 'brush' in gen_dir:
        method_name = 'brushnet'
    elif 'sd' in gen_dir:
        method_name = 'sd'
    else:
        method_name ='ours'
    save_json_name = osp.join(dst_base, f"generated_results_{method_name}.json")

    dst_dir_path_gen = gen_dir
...
if __name__ == "__main__":
    ...
    parser.add_argument('--gen_dir', type=str, required=True, help="attention method for sc")
    ...
    main(args.base_dir,args.gen_dir)
