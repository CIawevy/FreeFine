...
inp_mode = 'lama_sd'  #'sd','lama_sd'

dst_dir_path_exp = "/data/Hszhu/dataset/PIE-Bench_v1/Subset_lama_sd/EXP_masks/"
dst_dir_path_inp = "/data/Hszhu/dataset/PIE-Bench_v1/Subset_lama_sd/inp_imgs/"
...
for da_n, da in tqdm(data_parts[0].items(), desc='Proceeding inpainting (data_parts lama sd)'):
    # da_n = '3' #378
    # da = data[da_n]
...
save_json(data,"/data/Hszhu/dataset/PIE-Bench_v1/Subset_lama_sd/packed_data_full_EXP_INP.json")
