...
new_data = dict()
for da_n, da in tqdm(data_parts[1].items(), desc='Proceeding inpainting (Part 1)'):
...
save_json(new_data,"/data/Hszhu/dataset/PIE-Bench_v1/generated_dataset_full_pack_1.json")
