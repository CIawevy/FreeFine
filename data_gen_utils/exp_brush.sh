...
#python examples/brushnet/inpaint_brushnet_bg_parser.py  --base_dir "$BASE_DIR"  --data_id "$DATA_ID"
#python examples/brushnet/inpaint_brushnet_eval_gb_parser.py  --base_dir "$BASE_DIR"  --data_id "$DATA_ID"
