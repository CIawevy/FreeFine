...
def main(dst_base,method_name,data_id=None):
    ...
    # save_json_name = osp.join(dst_base, f"generated_results_refine_{method_name}_no_blend.json")
    save_json_name = osp.join(dst_base, f"Gen_results_refine_ours_35_no_blend.json")
...
if __name__ == "__main__":
    ...
    main(args.base_dir,args.method_name)
