...
for da_n, da in tqdm(data_parts[0].items(), desc='Proceeding inpainting (data_parts 0)'):
    # da_n = '3' #378
    # da = data[da_n]
    ...
    # if not stat:
    #TODO： sd inpaint filter ，nlp based text sim filter
    expansion_mask_list, inpainting_imgs_list, lama_inp_list = model.expansion_and_inpainting_func(img, mask_list,
                                                                                                   obj_label_list,
                                                                                                   max_resolution=512,
                                                                                                   expansion_step=10,
                                                                                                   max_try_times=10,
...
save_json(data,"/data/Hszhu/dataset/PIE-Bench_v1/packed_data_full_EXP_INP_0.json")
