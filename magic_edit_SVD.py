...
trans_img_path = "/data/Hszhu/generative-models/outputs/simple_video_sample/sv3d_u/000000_4.jpg"
#cv2 loading to ndarray

#####################################################
original_image= cv2.imread(image_path)
original_image = cv2.cvtColor(original_image, cv2.COLOR_BGR2RGB)
transformed_image = cv2.imread(trans_img_path)
...
trans_img = Image.open(image_path)
